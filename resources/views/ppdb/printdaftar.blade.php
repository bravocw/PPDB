...
<head>
    ...
    <title>Bukti Pendaftaran SMP PUTRA PERINTIS | {{ $item['id'] }} - {{ $item['s_namalengkap'] }} </title>
...
<body>
    <header class="d-flex justify-content-start align-items-center">
        ...
        <div class="px-4 header judul">
            <h6>PANITIA PENERIMAAN PESERTA DIDIK BARU <br> SMP PUTRA PERINTIS TP 2023-2024</h6>
            <p>Jl. Kp. Cipicung RT 03 RW 03, Kec. Cikidang, Kab. Sukabumi, Prov. Jawa Barat</p>
            <p>Website: .... | Telepon : ....</p>
        </div>
    </header>
    ...
    <div class="bukti text-center">
        ...
        <H6>SMP PUTRA PERINTIS TP 2023-2024</H6>
    </div>
    <main>
        <div class="satu">
        ...
        <div class="tiga">
            ...
            <p>Bank BNI: 1234567890 A.N SMP PUTRA PERINTIS</p>
        </div>
    </main>
